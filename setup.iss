...
#define MyAppName "Random Photo Screensaver 4"
...
[Registry]
Root: HKCU; Subkey: "Control Panel\Desktop"; ValueType: string; ValueName: "SCRNSAVE.EXE"; ValueData: "{sys}\Random Photo Screensaver.scr"; Flags: uninsdeletevalue
